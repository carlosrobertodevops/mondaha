...
export 'modal_profile_edit_profile_model.dart';

class ModalProfileEditProfileWidget extends StatefulWidget {
  const ModalProfileEditProfileWidget({super.key});

  @override
  State<ModalProfileEditProfileWidget> createState() =>
      _ModalProfileEditProfileWidgetState();
}

class _ModalProfileEditProfileWidgetState
    extends State<ModalProfileEditProfileWidget> with TickerProviderStateMixin {
  late ModalProfileEditProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalProfileEditProfileModel());
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'MODAL_PROFILE_EDIT_PROFILE_close_rounded');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MODAL_PROFILE_EDIT_PROFILE_imageBorder_O');
                                            final selectedMedia =
                                                await selectMedia(
                                              maxWidth: 100.00,
                                              maxHeight: 100.00,
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'MODAL_PROFILE_EDIT_PROFILE_CANCEL_BTN_ON');
                                          Navigator.pop(context);
                                        },
                                        text:
                                            FFLocalizations.of(context).getText(
