...
import 'buscar_c_e_p_model.dart';
export 'buscar_c_e_p_model.dart';
...
class _BuscarCEPWidgetState extends State<BuscarCEPWidget>
    with TickerProviderStateMixin {
  late BuscarCEPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuscarCEPModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'BuscarCEP'});
    _model.cepTextController ??= TextEditingController();
    _model.cepFocusNode ??= FocusNode();

    _model.ruaAvTextController ??= TextEditingController();
    _model.ruaAvFocusNode ??= FocusNode();
    ...
    return Title(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: Color(0xFFFAD400),
              automaticallyImplyLeading: false,
              title: Text(
                FFLocalizations.of(context).getText(
                  '3mirzv3t' /* Consultar CEP */,
                ),
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'BUSCAR_C_E_P_BUSCAR_C_E_P_BTN_ON_TAP');
                                                      _model.apiResultokv =
                                                          await ApiViaCEPCall
                                                              .call();

                                                      if ((_model.apiResultokv
                                                              ?.succeeded ??
                                                          true)) {
                                                        // rua
                                                        safeSetState(() {
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.ruaAvTextController,
                                            focusNode: _model.ruaAvFocusNode,
                                            autofocus: true,
                                            obscureText: false,
