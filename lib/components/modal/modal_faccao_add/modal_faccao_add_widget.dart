...
class _ModalFaccaoAddWidgetState extends State<ModalFaccaoAddWidget>
  ...
  void initState() {
    ...
    _model.txtDataCriacaoTextController ??= TextEditingController();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          ...
          _model.txtDataCriacaoTextController?.text = dateTimeFormat(
            "d/M/y",
            _model.datePicked,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'MODAL_FACCAO_ADD_IconButtonDataCriacao_O');
                                  // Data de Nascimento
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (confirmDialogResponse) {
                                        if (_model.uploadImagem == true) {
                                          ...
                                          _model.outputFaccaoAddyesPhoto =
