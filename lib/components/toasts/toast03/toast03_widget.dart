...
class _Toast03WidgetState extends State<Toast03Widget> {
  late Toast03Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Toast03Model());
        ...
        child: Row(
          ...
          children: [
            ...
            FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('TOAST03_COMP_close_rounded_ICN_ON_TAP');
