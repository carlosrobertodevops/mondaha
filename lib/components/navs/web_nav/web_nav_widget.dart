    ...
    return FutureBuilder<List<UsuariosViewRow>>(
      future: UsuariosViewTable().querySingleRow(
        queryFn: (q) => q.eqOrNull(
          'user_id',
          FFAppState().UsuarioAtualTipoUsuarioId.toString(),
        ),
      ),
      builder: (context, snapshot) {
        ...
        List<UsuariosViewRow> rowUsuariosViewRowList = snapshot.data!;

        final rowUsuariosViewRow = rowUsuariosViewRowList.isNotEmpty
            ? rowUsuariosViewRowList.first
            : null;
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'WEB_NAV_COMP_Icon_be1vywrz_ON_TAP');
                                FFAppState().webbarminimal = true;
                                safeSetState(() {});
                              },
                              child: Icon(
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                context.pushNamed(MainMapaWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'WEB_NAV_COMP_Icon_z7uxzz2w_ON_TAP');
                                  FFAppState().webbarminimal = false;
                                  safeSetState(() {});
                                },
                                child: Icon(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'WEB_NAV_COMP_lightDark_small_ON_TAP');
