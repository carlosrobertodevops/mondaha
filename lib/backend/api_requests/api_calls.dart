...
class MembrosCoordenadasAddCall {
  static Future<ApiCallResponse> call({
    int? membroId,
  }) async {
    final ffApiRequestBody = '''
{
  "p_membro_id": ${membroId}
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'MembrosCoordenadasAdd',
      apiUrl:
          'https://buzlazhtcndpegsnijcw.supabase.co/rest/v1/rpc/add_membros_coordenadas',
      callType: ApiCallType.POST,
      headers: {
        'Content-Type': 'application/json',
        'apikey':
...
class MembrosCoordenadasDelCall {
  static Future<ApiCallResponse> call({
    int? membroId,
  }) async {
    final ffApiRequestBody = '''
{
  "p_membro_id": ${membroId}
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'MembrosCoordenadasDel',
      apiUrl:
          'https://buzlazhtcndpegsnijcw.supabase.co/rest/v1/rpc/del_membros_coordenadas',
      callType: ApiCallType.POST,
      headers: {
        'Content-Type': 'application/json',
        'apikey':
