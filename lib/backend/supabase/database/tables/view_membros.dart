...
class ViewMembrosTable extends SupabaseTable<ViewMembrosRow> {
  @override
  String get tableName => 'view_membros';

  @override
  ViewMembrosRow createRow(Map<String, dynamic> data) => ViewMembrosRow(data);
}

class ViewMembrosRow extends SupabaseDataRow {
  ViewMembrosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewMembrosTable();
