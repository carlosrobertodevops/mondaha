...
class ViewMembrosAllTable extends SupabaseTable<ViewMembrosAllRow> {
  @override
  String get tableName => 'view_membros_all';

  @override
  ViewMembrosAllRow createRow(Map<String, dynamic> data) =>
      ViewMembrosAllRow(data);
}

class ViewMembrosAllRow extends SupabaseDataRow {
  ViewMembrosAllRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewMembrosAllTable();
