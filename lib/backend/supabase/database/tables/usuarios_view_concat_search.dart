...
class UsuariosViewConcatSearchTable
    extends SupabaseTable<UsuariosViewConcatSearchRow> {
  @override
  String get tableName => 'usuarios_view_concat_search';

  @override
  UsuariosViewConcatSearchRow createRow(Map<String, dynamic> data) =>
      UsuariosViewConcatSearchRow(data);
}

class UsuariosViewConcatSearchRow extends SupabaseDataRow {
  UsuariosViewConcatSearchRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => UsuariosViewConcatSearchTable();
