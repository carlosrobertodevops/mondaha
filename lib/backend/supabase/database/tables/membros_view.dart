...
class MembrosViewTable extends SupabaseTable<MembrosViewRow> {
  @override
  String get tableName => 'membros_view';

  @override
  MembrosViewRow createRow(Map<String, dynamic> data) => MembrosViewRow(data);
}

class MembrosViewRow extends SupabaseDataRow {
  MembrosViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MembrosViewTable();
