...
class MembrosViewPdfMaterializadaTable
    extends SupabaseTable<MembrosViewPdfMaterializadaRow> {
  @override
  String get tableName => 'membros_view_pdf_materializada';

  @override
  MembrosViewPdfMaterializadaRow createRow(Map<String, dynamic> data) =>
      MembrosViewPdfMaterializadaRow(data);
}

class MembrosViewPdfMaterializadaRow extends SupabaseDataRow {
  MembrosViewPdfMaterializadaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MembrosViewPdfMaterializadaTable();
