...
class ViewMembrosGetAllTable extends SupabaseTable<ViewMembrosGetAllRow> {
  @override
  String get tableName => 'view_membros_get_all';

  @override
  ViewMembrosGetAllRow createRow(Map<String, dynamic> data) =>
      ViewMembrosGetAllRow(data);
}

class ViewMembrosGetAllRow extends SupabaseDataRow {
  ViewMembrosGetAllRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewMembrosGetAllTable();
