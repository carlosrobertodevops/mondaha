...
class MembrosViewConcatSeachMaterializadaTable
    extends SupabaseTable<MembrosViewConcatSeachMaterializadaRow> {
  @override
  String get tableName => 'membros_view_concat_seach_materializada';

  @override
  MembrosViewConcatSeachMaterializadaRow createRow(Map<String, dynamic> data) =>
      MembrosViewConcatSeachMaterializadaRow(data);
}

class MembrosViewConcatSeachMaterializadaRow extends SupabaseDataRow {
  MembrosViewConcatSeachMaterializadaRow(Map<String, dynamic> data)
      : super(data);

  @override
  SupabaseTable get table => MembrosViewConcatSeachMaterializadaTable();
