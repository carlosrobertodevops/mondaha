...
class MembrosViewSeachTable extends SupabaseTable<MembrosViewSeachRow> {
  @override
  String get tableName => 'membros_view_seach';

  @override
  MembrosViewSeachRow createRow(Map<String, dynamic> data) =>
      MembrosViewSeachRow(data);
}

class MembrosViewSeachRow extends SupabaseDataRow {
  MembrosViewSeachRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MembrosViewSeachTable();
