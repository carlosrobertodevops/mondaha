...
class _MainFaccoesWidgetState extends State<MainFaccoesWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.countFaccoes = FFAppState().CountFaccoes;
      safeSetState(() {});
    });
                                    ...
                                    children: [
                                        ...
                                        child: TextFormField(
                                          ...
                                          onChanged: (_) =>
                                            ...
                                            () async {
                                              ...
                                              _model.outputQueryFaccaoCount2 =
                                                  await FaccoesViewConcatSearchTable()
                                                      .queryRows(
                                                queryFn: (q) => q
                                                    .ilike(
                                                      'pesquisa',
                                              ...
                                              _model.countFaccoes = _model
                                                  .outputQueryFaccaoCount1
                                                  ?.length;
                                              safeSetState(() {});
                                              FFAppState().CountFaccoes = _model
                                                  .outputQueryFaccaoCount1!
                                                  .length;
                                              safeSetState(() {});
                                          ...
                                          onFieldSubmitted: (_) async {
                                            ...
                                            _model.outputQueryFaccaoCount1 =
                                                await FaccoesViewConcatSearchTable()
                                                    .queryRows(
                                              queryFn: (q) => q
                                                  .ilike(
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          safeSetState(() {});
                                          _model.outputQueryFaccaoCount3 =
                                              await FaccoesViewConcatSearchTable()
                                                  .queryRows(
                                            queryFn: (q) => q
                                                .ilike(
                                          ...
                                          _model.countFaccoes = _model
                                              .outputQueryFaccaoCount1?.length;
                                          safeSetState(() {});
                                          FFAppState().CountFaccoes = _model
                                              .outputQueryFaccaoCount1!.length;
                                          safeSetState(() {});
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return InkWell(
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'MAIN_FACCOES_PAGE_ListViewFaccao_ON_TAP');
                                                                          await actions
                                                                              .resetTimerAction(
                                                                            context,
                                                                          );
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onRefresh:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_FACCOES_ListViewFaccao_ON_PULL_TO_R');
                                                                            _model.outputCountFaccoesSearch1 =
                                                                                await FaccoesViewConcatSearchTable().queryRows(
                                                                              queryFn: (q) => q
                                                                                  .ilike(
                                                                                    'pesquisa',
                                                                                    functions.pesquisaLikeCS(_model.textFieldPesquisarFaccoesTextController.text),
                                                                                  )
                                                                                  .order('nome', ascending: true),
                                                                            );
                                                                            _model.countFaccoes =
                                                                                listViewFaccaoFaccoesViewConcatSearchRowList.length;
                                                                            safeSetState(() {});
                                                                          },
                                                                          child:
                                                                              ListView.builder(
                                                                            ...
                                                                            itemCount:
                                                                                listViewFaccaoFaccoesViewConcatSearchRowList.length,
                                                                            itemBuilder:
                                                                                (context, listViewFaccaoIndex) {
                                                                              final listViewFaccaoFaccoesViewConcatSearchRow = listViewFaccaoFaccoesViewConcatSearchRowList[listViewFaccaoIndex];
                                                                              return Builder(
                                                                                          ...
                                                                                          children: [
                                                                                            ClipRRect(
                                                                                              ...
                                                                                              child: CachedNetworkImage(
                                                                                                ...
                                                                                                imageUrl: listViewFaccaoFaccoesViewConcatSearchRow.imagemPath != null && listViewFaccaoFaccoesViewConcatSearchRow.imagemPath != ''
                                                                                                    ? valueOrDefault<String>(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return InkWell(
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'MAIN_FACCOES_ListViewFaccaoBuscar_ON_TAP');
                                                                          await actions
                                                                              .resetTimerAction(
                                                                            context,
                                                                          );
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onRefresh:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_FACCOES_ListViewFaccaoBuscar_ON_PUL');
                                                                            _model.outputCountFaccoesSearch2 =
                                                                                await FaccoesViewConcatSearchTable().queryRows(
                                                                              queryFn: (q) => q
                                                                                  .ilike(
                                                                                    'pesquisa',
                                                                            ...
                                                                            _model.countFaccoes =
                                                                                listViewFaccaoBuscarFaccoesViewConcatSearchRowList.length;
                                                                            safeSetState(() {});
                                                                          },
                                                                          child:
                                                                              ListView.builder(
                                                                            ...
                                                                            itemCount:
                                                                                listViewFaccaoBuscarFaccoesViewConcatSearchRowList.length,
                                                                            itemBuilder:
                                                                                (context, listViewFaccaoBuscarIndex) {
                                                                              final listViewFaccaoBuscarFaccoesViewConcatSearchRow = listViewFaccaoBuscarFaccoesViewConcatSearchRowList[listViewFaccaoBuscarIndex];
                                                                              return Builder(
                                                                                builder: (context) => Padding(
                                                                                  padding: EdgeInsetsDirectional.fromSTEB(16.0, 8.0, 16.0, 0.0),
                                                                                  child: InkWell(
                                                                                          ...
                                                                                          children: [
                                                                                            ClipRRect(
                                                                                              ...
                                                                                              child: CachedNetworkImage(
                                                                                                fadeInDuration: Duration(milliseconds: 100),
                                                                                                fadeOutDuration: Duration(milliseconds: 100),
                                                                                                imageUrl: listViewFaccaoBuscarFaccoesViewConcatSearchRow.imagemPath != null && listViewFaccaoBuscarFaccoesViewConcatSearchRow.imagemPath != ''
                                                                                                    ? valueOrDefault<String>(
